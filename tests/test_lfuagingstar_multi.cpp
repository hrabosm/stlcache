...
#define BOOST_TEST_MODULE "STLCachePolicyLFUAging*Multi"
...
BOOST_AUTO_TEST_CASE(lastInserted) {
    cache<int,string,policy_lfuagingstar_multi<3600> > c1(3);
...
BOOST_AUTO_TEST_CASE(stringAsKey) {
    cache<string, int, policy_lfuagingstar_multi<3600> > c1(3);
...
BOOST_AUTO_TEST_CASE(expire) {
    cache<int,string,policy_lfuagingstar_multi<1> > c1(3);
